            ...
            return (
              ...
              >
                ...
                <div className="mt-2 min-w-0">
                  <p className="text-sm font-medium line-clamp-2 leading-tight">{displayTitle}</p>
                  <p className="text-xs text-muted-foreground mt-0.5 line-clamp-1">{displayAuthor}</p>
